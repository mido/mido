...
from .midifiles import MidiFile, MidiTrack
...
'''
    ...
    def setUpClass(cls):
        ...
        with MidiFile() as midi:
            ...
            track.extend([
                Message('program_change', program=12, time=0),
                Message('note_on', note=64, velocity=64, time=32),
                Message('note_off', note=64, velocity=127, time=128),
                ])
    ...
    def test_midifile_from_bytesIO(self):
        ...
        """
        midifile = MidiFile(file=io.BytesIO(self.expected_bio))
