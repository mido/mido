...
class Spec:
    ...
    def __init__(self, status_byte: int, type_: str, value_names: tuple[str, ...], length: int):
...
def _make_spec_lookups(specs: List[Spec]) -> tuple[dict[Union[int, str], Spec], dict[int, Spec], dict[str, Spec]]:
    lookup = {}
    by_status = {}
    by_type = {}
